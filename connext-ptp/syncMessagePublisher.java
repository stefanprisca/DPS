...
java -Djava.ext.dirs=$NDDSHOME/lib/java syncMessagePublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/lib/java syncMessageSubscriber <domain_id>
*/
...
public class syncMessagePublisher {
    ...
    private static void publisherMain(int domainId, int sampleCount) {
        ...
        Topic topic = null;
        syncMessageDataWriter writer = null;
        ...
        try {
            ...
            syncMessage instance = new syncMessage();
            ...
            ++count) {
                ...
                System.out.println("Writing syncMessage, count " + count);
