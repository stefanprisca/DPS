...
/**
* A sequence of syncMessage instances.
*/
public final class syncMessageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public syncMessageSeq() {
        super(syncMessage.class);
    }

    public syncMessageSeq (int initialMaximum) {
        super(syncMessage.class, initialMaximum);
    }

    public syncMessageSeq (Collection elements) {
        super(syncMessage.class, elements);
    }

    public  syncMessage get(int index) { 
        return (syncMessage) super.get(index); 
    }
