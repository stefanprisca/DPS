...
public class syncMessageTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "syncMessage";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final syncMessageTypeSupport _singleton
    = new syncMessageTypeSupport();
    ...
    */
    public static syncMessageTypeSupport get_instance() {
        return _singleton;
    }

    public static syncMessageTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return syncMessageTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>syncMessage</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        syncMessage typedDst = (syncMessage) destination;
        syncMessage typedSrc = (syncMessage) source;
        ...
        Object sample) 
    {
        ...
        syncMessage typedSrc = (syncMessage) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            syncMessage typedDst = (syncMessage) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            syncMessage typedDst = (syncMessage) sample;
    ...
    int mask) {
        return new syncMessageDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new syncMessageDataReader(native_reader, listener, mask, this);   
    ...
    protected syncMessageTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,syncMessageTypeCode.VALUE,syncMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected syncMessageTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,syncMessageTypeCode.VALUE,syncMessage.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
